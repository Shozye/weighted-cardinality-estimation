...
from weighted_cardinality_estimation import BaseLogExpSketch, BaseLogExpSketchJacc, BaseQSketch, ExpSketchFloat, FastExpSketch, ExpSketch, FastGMExpSketch, BaseLogExpSketch, FastLogExpSketch, FastQSketch, QSketchDyn, BaseShiftedLogExpSketch, FastShiftedLogExpSketch, QSketch, WeightedMinHash
...
_SKETCH_CLS_NO_JACC_SEEDS = {
    ...
    "BaseLogExpSketch(k=2)": lambda m, seeds: BaseLogExpSketch(m, seeds, amount_bits=8, logarithm_base=2),
    "BaseLogExpSketch(k=2.2)": lambda m, seeds: BaseLogExpSketch(m, seeds, amount_bits=8, logarithm_base=2.2),
    "BaseLogExpSketch(k=1.8)": lambda m, seeds: BaseLogExpSketch(m, seeds, amount_bits=8, logarithm_base=1.8),
