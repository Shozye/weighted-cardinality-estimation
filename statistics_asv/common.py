...
from weighted_cardinality_estimation import ExpSketch, FastExpSketch, FastQSketch, QSketchDyn

SketchType = Union[ExpSketch, FastExpSketch, FastQSketch, QSketchDyn]
