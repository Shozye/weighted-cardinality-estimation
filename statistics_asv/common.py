...
from weighted_cardinality_estimation import ExpSketch, FastExpSketch, BaseQSketch, FastGMExpSketch, FastQSketch, QSketchDyn

SketchType = Union[ExpSketch, FastExpSketch, FastGMExpSketch, BaseQSketch, FastQSketch, QSketchDyn]
