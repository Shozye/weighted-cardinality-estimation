...
public:
    ...
    [[nodiscard]] double estimate_direct(float logarithm_base) const;
    [[nodiscard]] double estimate_newton_cold(float logarithm_base) const;
    [[nodiscard]] double estimate_newton_warm(float logarithm_base) const;
