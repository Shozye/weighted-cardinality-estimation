...
std::size_t QSketch::get_sketch_size() const { return size; }
std::vector<std::uint32_t> QSketch::get_seeds() const { return seeds_.toVector(); }
...
void QSketch::add_many(const std::vector<std::string>& elems,
