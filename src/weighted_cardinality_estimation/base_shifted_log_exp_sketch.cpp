...
double BaseShiftedLogExpSketch::estimate_direct() const {
    return structure.estimate_direct(logarithm_base);
}

double BaseShiftedLogExpSketch::estimate_newton_cold() const {
    return structure.estimate_newton_cold(logarithm_base);
}

double BaseShiftedLogExpSketch::estimate_newton_warm() const {
